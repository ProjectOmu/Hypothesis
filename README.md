...
We are happy to accept contributions from anybody. Get in [Discord Server](https://discord.gg/J5uqYJsrAb) if you want to help. Feel free to check the [list of issues](https://github.com/ProjectOmu/Hypothesis/issues) that need to be done and anybody can pick them up. Don't be afraid to ask for help either!
